...
const Blog = () => {
	...
	return (
		<div className="flex w-full pb-20 md:px-[60px] px-8 flex-col gap-16 justify-center items-center">
					...
					return (
						...
						>
							<img
								...
								alt={post.title}
							/>
							<div className="flex items-center w-full gap-10 px-4 mt-3">
							...
							<div className="px-4 py-3 font-medium text-blue-600 cursor-pointer">
								Read More
							</div>
						</div>
					);
